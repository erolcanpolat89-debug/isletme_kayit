...
st.markdown('\n<style>\n/* ANA SEKME TUŞLARI: DÜKKAN / TOPTAN / FİRMALAR / CARİ / BORÇ-ALACAK */\ndiv[data-testid="stTabs"] > div[data-baseweb="tab-list"] {\n    gap: 10px !important;\n    padding: 6px !important;\n    overflow-x: auto !important;\n    background: rgba(8, 11, 18, .55) !important;\n    border-radius: 18px !important;\n}\n\ndiv[data-testid="stTabs"] button[data-baseweb="tab"] {\n    position: relative !important;\n    min-height: 52px !important;\n    padding: 10px 18px !important;\n    border: 1px solid rgba(255, 215, 90, .35) !important;\n    border-radius: 15px !important;\n    background: linear-gradient(145deg, rgba(27,31,43,.97), rgba(7,10,17,.97)) !important;\n    color: #f7f7f7 !important;\n    font-weight: 900 !important;\n    box-shadow: inset 0 1px 0 rgba(255,255,255,.08), 0 5px 15px rgba(0,0,0,.32) !important;\n    transition: transform .14s ease, background .18s ease, border-color .18s ease, box-shadow .18s ease, filter .18s ease !important;\n}\n\ndiv[data-testid="stTabs"] button[data-baseweb="tab"] > div {\n    color: inherit !important;\n}\n\ndiv[data-testid="stTabs"] button[data-baseweb="tab"]:hover {\n    transform: translateY(-3px) scale(1.02) !important;\n    border-color: #ffd84d !important;\n    background: linear-gradient(145deg, rgba(72,58,22,.98), rgba(17,19,29,.98)) !important;\n    box-shadow: 0 0 0 1px rgba(255,216,77,.28), 0 0 18px rgba(255,190,45,.46), 0 10px 23px rgba(0,0,0,.42) !important;\n    filter: brightness(1.10) !important;\n}\n\ndiv[data-testid="stTabs"] button[data-baseweb="tab"][aria-selected="true"] {\n    transform: translateY(2px) scale(.975) !important;\n    border-color: #ffe27a !important;\n    background: linear-gradient(145deg, rgba(94,74,20,.98), rgba(28,26,18,.98)) !important;\n    color: #ffe68a !important;\n    box-shadow: inset 0 5px 11px rgba(0,0,0,.48), inset 0 0 17px rgba(255,211,64,.14), 0 0 15px rgba(255,193,46,.38) !important;\n}\n\ndiv[data-testid="stTabs"] button[data-baseweb="tab"]:active {\n    transform: translateY(4px) scale(.96) !important;\n    box-shadow: inset 0 6px 13px rgba(0,0,0,.54), inset 0 0 20px rgba(255,205,60,.18) !important;\n}\n\ndiv[data-testid="stTabs"] button[data-baseweb="tab"]::after {\n    content: "" !important;\n    position: absolute !important;\n    inset: -1px !important;\n    border-radius: 15px !important;\n    padding: 1px !important;\n    pointer-events: none !important;\n    background: linear-gradient(90deg, #ff304f, #ff9f1c, #ffe45e, #35e58b, #25b7ff, #7c5cff, #ff4fd8, #ff304f) !important;\n    background-size: 300% 100% !important;\n    animation: mainTabsRGB 7s linear infinite !important;\n    opacity: .55 !important;\n    -webkit-mask: linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0) !important;\n    -webkit-mask-composite: xor !important;\n    mask-composite: exclude !important;\n}\n\n@keyframes mainTabsRGB {\n    0% { background-position: 0% 50%; }\n    50% { background-position: 100% 50%; }\n    100% { background-position: 0% 50%; }\n}\n\n@media (max-width: 800px) {\n    div[data-testid="stTabs"] button[data-baseweb="tab"] {\n        min-width: 125px !important;\n        padding: 9px 13px !important;\n    }\n}\n</style>\n', unsafe_allow_html=True)
